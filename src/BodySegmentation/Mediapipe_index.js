...
/**
 * @typedef {Record<string, { id: number, color: [number, number, number]}>} BodySegPalette
 */

/**
 * @typedef {Object} BodySegConfig
 * @property {string} [runtime]
 * @property {string} [modelType]
 * @property {string} [solutionPath]
 * @property {string} [locateFile]
 * @prop {boolean} [flipHorizontal]
 */

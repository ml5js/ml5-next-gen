/*
 * TensorflowDepthEstimation: Real-time Depth Estimation in the Browser
...
/**
 * @class
 * TensorflowDepthEstimation class using the TensorFlow.js ARPortraitDepth model.
 */
...
export default TensorflowDepthEstimation;